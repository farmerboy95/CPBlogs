...
Ta cũng có những cấu trúc dữ liệu tương tự có thể xử lý bất kỳ loại hàm kết hợp và truy vấn đoạn nào trong $O(1)$. Một trong số chúng là [Disjoint Sparse Table](../../../../Codechef/data_structures/disjoint_sparse_table/disjoint_sparse_table.md). Một cái khác là [Sqrt Tree - Coming soon]().
